...
public class DispenseChange implements State {
    ...
    public void collectCash(int cash) {
        ...
        System.out.println("Dispensing Change. Unable to collect cash");
    }
    @Override
    ...
    public void dispenseItem(String productCode) {
        ...
        System.out.println("Dispensing change. Unable to dispense Item");
    }
    @Override
    public void cancelTransaction() {
        // throw new RuntimeException("Dispensing change. Unable to cancel transaction");
        System.out.println("Dispensing change. Unable to cancel transaction");
    }
}
