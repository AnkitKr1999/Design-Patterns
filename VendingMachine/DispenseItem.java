...
public class DispenseItem implements State {
    ...
    public void collectCash(int cash) {
        ...
        System.out.println("Dispensing item.Unable to collect cash");
    }

    @Override
    public void dispenseChange(String productCode) {
        // throw new RuntimeException ("Dispensing item.Unable to dispense change");
        System.out.println("Dispensing item.Unable to dispense change");
    }
    ...
    public void cancelTransaction() {
        ...
        System.out.println("Dispensing item.Unable to cancel the Transaction");
    }
}