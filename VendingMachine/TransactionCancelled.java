...
private VendingMachine vendingMachine;
    ...
    public void collectCash(int cash) {
        ...
        System.out.println("Unable to collect cash in a cancelled transaction");
    }

    @Override
    public void dispenseChange(String productCode) {
        // throw new RuntimeException ("Unable to dispense change in a cancelled transaction");
        System.out.println("Unable to dispense change in a cancelled transaction");
    }

    @Override
    public void dispenseItem(String productCode) {
        // throw new RuntimeException("Unable to dispense item in a cancelled transaction");
        System.out.println("Unable to dispense item in a cancelled transaction");
    }
